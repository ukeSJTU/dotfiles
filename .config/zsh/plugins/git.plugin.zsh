# Vendored from https://github.com/ohmyzsh/ohmyzsh/blob/master/plugins/git/git.plugin.zsh
# Snapshot date: 2026-08-04, self-contained (no oh-my-zsh core deps).
# To update: re-fetch the URL above and diff against this file by hand.
